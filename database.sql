...
"sign_sun" VARCHAR (15) NOT NULL,
"description_sun" VARCHAR NOT NULL
);

INSERT INTO "sun" ("sign_sun", "description_sun")
...
CREATE TABLE "moon" (
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_moon" VARCHAR (15) NOT NULL,
"description_moon" VARCHAR NOT NULL
);

INSERT INTO "moon" ("sign_moon", "description_moon")
...
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_asc" VARCHAR (15) NOT NULL,
"description_asc" VARCHAR NOT NULL
);

INSERT INTO "ascendent" ("sign_asc", "description_asc")
...
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_mercury" VARCHAR (15) NOT NULL,
"description_mercury" VARCHAR NOT NULL
);

INSERT INTO "mercury" ("sign_mercury", "description_mercury")
...
CREATE TABLE "venus" (
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_venus" VARCHAR (15) NOT NULL,
"description_venus" VARCHAR NOT NULL
);

INSERT INTO "venus" ("sign_venus", "description_venus")
...
CREATE TABLE "mars" (
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_mars" VARCHAR (15) NOT NULL,
"description_mars" VARCHAR NOT NULL
);

INSERT INTO "mars" ("sign_mars", "description_mars")
...
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_jupiter" VARCHAR (15) NOT NULL,
"description_jupiter" VARCHAR NOT NULL
);

INSERT INTO "jupiter" ("sign_jupiter", "description_jupiter")
...
CREATE TABLE "saturn" (
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_saturn" VARCHAR (15) NOT NULL,
"description_saturn" VARCHAR NOT NULL
);

INSERT INTO "saturn" ("sign_saturn", "description_saturn")
...
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_neptune" VARCHAR (15) NOT NULL,
"description_neptune" VARCHAR NOT NULL
);

INSERT INTO "neptune" ("sign_neptune", "description_neptune")
...
CREATE TABLE "uranus" (
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_uranus" VARCHAR (15) NOT NULL,
"description_uranus" VARCHAR NOT NULL
);

INSERT INTO "uranus" ("sign_uranus", "description_uranus")
...
CREATE TABLE "pluto" (
"id" SERIAL PRIMARY KEY NOT NULL,
"sign_pluto" VARCHAR (15) NOT NULL,
"description_pluto" VARCHAR NOT NULL
);

INSERT INTO "pluto" ("sign_pluto", "description_pluto")
