      ...
      <div>
        ...
        <form className="registerForm" onSubmit={this.registerUser}>
          ...
          <p>To register for Planit, you will need your birth chart information.
            <br />
            You can find this information for free on websites like <a className="regLinkRef" href="https://astro.cafeastrology.com/natal.php">astro.cafeastrology</a> or <a className="regLinkRef" href="https://www.costarastrology.com/natal-chart/">Co-Star</a>
          </p>
          <div>
